...
namespace UptalentFramework.Data
{
    public interface IRepository<T>
    {
        ...
        IPagedList<T> PagedList(int pageIndex, int pageSize, string sqlCondition, params object[] args);
        IPagedList<T> PagedList(int pageIndex, int pageSize, string sqlCondition);
